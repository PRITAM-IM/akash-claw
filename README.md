...
- `OPENCLAW_HTTP_AUTH_USER` - optional HTTP Basic Auth username for the UI (default: `openclaw`)
- `OPENCLAW_HTTP_AUTH_PASSWORD` - optional HTTP Basic Auth password for the UI (when set, the UI and WebSocket require login)
Notes:
